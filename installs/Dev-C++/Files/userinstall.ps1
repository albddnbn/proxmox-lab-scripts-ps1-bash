param(
    ...
    # Shortcut #1
    [string]$UserShortcutPath = 'C:\Program Files (x86)\Dev-C++\Dev-C++.lnk',
    # Shortcut #2
    [string]$PublicShortcutPath = 'C:\Program Files (x86)\Dev-C++\PublicInstall\Dev-C++.lnk',
    ## Step 3: Set application name - dictates the name of the folder created at base of specified user's home directory.
    [string]$ApplicationName = 'Dev-C++'
)
...
$LOGFILE = "C:\WINDOWS\Logs\Software\Dev-C++-install.log"
